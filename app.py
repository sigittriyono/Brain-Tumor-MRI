...
GDRIVE_ID    = "1EtJCL9iAprWNf99F9u3isxf__8K_zTwC"
CLASS_NAMES  = ["Glioma Tumor", "Meningioma Tumor", "No Tumor", "Pituitary Tumor"]
IMG_SIZE     = (240, 240)
CLASS_COLORS = ["#E74C3C", "#E67E22", "#27AE60", "#2980B9"]
CLASS_DESC   = {
    "Glioma Tumor":     "Tumor ganas yang tumbuh dari sel glial otak atau sumsum tulang belakang.",
    "Meningioma Tumor": "Tumor (umumnya jinak) yang tumbuh pada selaput pelindung otak (meninges).",
    "No Tumor":         "Tidak ditemukan indikasi tumor pada hasil scan MRI.",
    "Pituitary Tumor":  "Tumor pada kelenjar pituitari (hipofisis) di bagian dasar otak.",
}
